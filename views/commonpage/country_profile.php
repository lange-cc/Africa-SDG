...
<!--        <button class="btn-close" data-close=".overlay,.pop-up">&times;</button>-->
            ...
            <div class="col-lg-5">
                <div class="country-card-widget">
                    <div class="country-info">
                        ...
                        <p class="country-rank"><?=$this->Translate('Rank');?> : <span v-html="country_rank"></span> <?=$this->Translate('out of');?> 51</p>
                    </div>
                ...
                <div class="country-card-widget chart-section">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <button class="btn-close pull-right country-profile-close-btn" data-close=".overlay,.pop-up">&times;</button>
                                ...
                                <div class="col-12">
                                    <div class="sdg-cards-icons" v-if="sdgdata != null">
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[0].color}"
                                        ...
                                        <!-- 2. Zero Hunger -->
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[1].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[2].color}"
                                        ...
                                        <!-- 4. Quality Education -->
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[3].color}"
                                        ...
                                        <!-- 5. Gender Equality -->
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[4].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[5].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[6].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[7].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[8].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[9].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[10].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[11].color}"
                                        ...
                                        <!-- 13. Climate Action -->
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[12].color}"
                                        ...
                                        <!-- 14. Life Below Water -->
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[13].color}"
                                        ...
                                        <!-- 15. Life On Land -->
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[14].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[15].color}"
                                        ...
                                        <div class="sdg-goal-card"
                                             :style="{'background-color': sdgdata[16].color}"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="sdg-cards-icons" v-if="sdgtrenddata != null">
                                        ...
                                        <div class="sdg-arrow-box" v-for="(trend,index) in sdgtrenddata"  v-on:click="getTrendsIndicator('sdg'+(index+1),country_code)">
                                            <div class="upper-part">
                                                <div class="d-flex flex-row">
                                                    ...
                                                    <div class="sdg-name" v-if="2 == index+1"><?=$this->Translate('Zero <br> Hunger');?>
                                                    </div>
                                                    <div class="sdg-name" v-if="3 == index+1">
                                                        <?=$this->Translate('Good Health <br> And Well Being');?>
                                                    </div>
                                                    <div class="sdg-name" v-if="4 == index+1"><?=$this->Translate('Quality <br> Education');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="5 == index+1"><?=$this->Translate('Gender <br> Equality');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="6 == index+1"><?=$this->Translate('Clean Water <br> and Sanitation');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="7 == index+1"><?=$this->Translate('Affordable and <br> clean Energy');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="8 == index+1"><?=$this->Translate('Decent Work and <br> Economic Growth');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="9 == index+1"><?=$this->Translate('Industry, Innovation <br> and Infrastructure');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="10 == index+1"><?=$this->Translate('Reduced <br> Inequalities');?>
                                                       
                                                    </div>
                                                    <div class="sdg-name" v-if="11 == index+1"><?=$this->Translate('Sustainable cities <br> and Communities');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="12 == index+1"><?=$this->Translate('Responsible <br> consumption <br> and Production');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="13 == index+1"><?=$this->Translate('Climate <br> Action');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="14 == index+1"><?=$this->Translate('Climate <br> Action');?>
                                                   
                                                    </div>
                                                    <div class="sdg-name" v-if="15 == index+1"><?=$this->Translate('Life <br> Below Water');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="16 == index+1"><?=$this->Translate('Peace, Justice <br> and Strong <br> Institutions');?>
                                                        
                                                    </div>
                                                    <div class="sdg-name" v-if="17 == index+1"><?=$this->Translate('Peace, Justice <br> and Strong <br> Institutions');?>
                                                        
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="sdg-arrow">
                                                <i v-if="trend.value == 5" class="fa fa-long-arrow-right maintaining"></i>
                                                <i v-if="trend.value == 2" class="fa fa-long-arrow-right flat"></i>
                                                <i v-if="trend.value == 3" class="fa fa-long-arrow-right rotate-45"></i>
                                                <i v-if="trend.value == 1" class="fa fa-long-arrow-right rotate-270"></i>
                                                <i v-if="trend.value == 4" class="fa fa-long-arrow-right rotate-90"></i>
                                            </div>

                                            <div v-if="trend.value == ''" class="sdg-arrow d-flex flex-row" style="margin-top: 2px;">
                                        ...
                                        <!-- 18. Sustainable Development Goals -->
                                        <div class="sdg-goal-card sdg-arrow-box"
                                             style="background:#fff;padding: 10px;">
                                            <div class="body">
                                                <img src="<?= URL; ?>images/sdg-vector-icon/Vectors-18.png"
                                                     class="image-ht-80" alt="">
    ...
    <!--    ===============  legend  ============= -->
    <a class="profile-legend-widget" href="javascript:void(0)"  v-on:mouseover="showLegend(true)"  v-on:mouseleave="showLegend(false)" v-if="legend">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="legend-rating legend-trend bg-white shadow-sm text-left p-3 h-100">
                        ...
                        <div class="legend-item">
                            <div class="legend-color trend-5"><span class="fa fa-long-arrow-right trendsIndicProfile-icon"
                        ...
                        <div class="legend-item">
                            <div class="legend-color trend-2"><span class="fa fa-long-arrow-right trendsIndicProfile-icon"
                                                                    style="color:#e5873c"></span></div>
                            <div class="legend-name text-muted"><?=$this->Translate('Score stagnating or increasing at less than 50% of required');?>
                                rate
                            </div>
                        </div>

                        <div class="legend-item">
                            <div class="legend-color trend-1"><span class="fa fa-long-arrow-down trendsIndicProfile-icon"
