        ...
        <div class="index-heading">
            ...
            <div class="index-heading-search">
                <div class="input-container">
                    <input class="index-search-input" placeholder="<?=$this->Translate('Search country');?>">
        ...
        <div class="data-table-widget">
            <table id="index-data" class="index-data table table-striped display" style="width:100%">
                ...
                <tr v-for="(country,index) in countries">
                    <td v-on:click="getProfile(country.code)" class="index-country-name"><img :src="'<?= URL ?>images/flags/'+country.code+'.png'" width="50"> {{country.country}}</td>
                ...
                <tr v-for="(country,index) in emptydata">
                    ...
                    <td v-if="nextyeardata == true" class="text-center"><span>{{country.nextYearIndex_score}}</span></td>
                </tr>
                </tbody>
