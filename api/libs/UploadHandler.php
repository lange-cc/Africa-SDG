...
public function start($dir)
   {
     $this->run($options = null, $initialize = true, $error_messages = null,$dir);
   }


 public function run($options = null, $initialize = true, $error_messages = null,$dir) {
    $this->response = array();
    $this->options = array(
 ...
 return $this->RandomFileName().".".$ext;
...
{
$characters = '';
