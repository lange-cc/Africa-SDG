...
e.preventDefault();
   ...
   var url = site_location+'category/Addnew/';
...
e.preventDefault();
   ...
   var parent_level = $(this).attr('data-level');
   var par_index    = $(this).attr('data-parindex');
  $('#parent-id').val(parent_id);   
  $('#level').val(parent_level);   
  $('#parindex').val(par_index);
 });
// End of function
...
var url = site_location+'category/Delete/';


Confirmation("Are You Sure You want to delete this Category? Make sure there are no product assigned to it.",function(response){
   if(response)
   {
...
$('.cat-btn-update').on('click', function(e){
  e.preventDefault();
var id = $(this).attr('data-id');
var url = site_location+'category/Find/';
$.post(url, {id:id}, function(o){
...
e.preventDefault();
   var data = $(this).serialize();
   var url = site_location+'category/update/';
   $.post(url, data, function(o){
      var myObj   = JSON.parse(o);
      var status  = myObj.status;
      var sms     = myObj.message;
...
//start of function
$('#category-copy').on('click', function (e) {
e.preventDefault();
var url  = site_location+'category/copy/';
