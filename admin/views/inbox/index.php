...
<div class="col-lg-7 <?php if (!isset($this->readfromid)) { echo 'read-message'; }?>">
<div class="message-widget" style="border-bottom:50px solid #380b39;">
<div class="row">
<div class="col-lg-12 message-nav1" style="padding-right:0;">
 <div class="row">
<div class="col-lg-6">
<label ><span class="fa fa-hand-grab-o"></span> <span id="subject"><?php if (isset($subject)) {echo $subject;}?></span></label>
</div>
<div class="col-lg-6">
<label class="pull-right" id="date-time"><?php if (isset($date)) {echo $date;}?></label>
</div>
</div>  
</div>
</div>
...
<div class="col-lg-12 message-nav1" style="padding-right:0;">
 <div class="row">
<div class="col-lg-6">
<label><b>Names:</b> </label> <span id="sms-names"><?php if (isset($names)) {echo $names;}?></span><br>
<label>Email:</label> <span id="sms-mail"><?php if (isset($email)) {echo $email;}?></span>
</div>
<div class="col-lg-6">
<ul class="pull-right read-message-option">
<li>
<a href="" class="btn-sms-reply" data-id="<?php if (isset($id)) {echo $id;}?>" data-email="<?php if (isset($email)) {echo $email;}?>" data-names="<?php if (isset($names)) {echo $names;}?>"><span class="fa fa-reply"></span> Reply</a>
</li>
<li>
<a href="" class="btn-sms-delete" data-id="<?php if (isset($id)) {echo $id;}?>" ><span class="fa fa-trash"></span> Delete</a>
</li>
</ul>
</div>
</div>  
